...
function ITContactPeople() {
    ...
    const renderPeople = () => {
        ...
        return (
            <ul>
                {data.map((app, index) => (
                    <li key={index}>
                        {app.name}  {app.age}  {app.organizationUnit}
                    </li>
                ))}
            </ul>
        );
    ...
    return (
        <div>
            <h3 className="text-2xl font-bold">Dashboard &gt; IT Contact People</h3>
...
export default ITContactPeople;
